...
class OnboardingPageViewController: UIPageViewController, UIPageViewControllerDataSource {
    ...
    var pageHeadings = ["Welcome to Forever Young Fitness!", "Flexx Pics!", "Programs!", "Simplicity" ,"Workout Reminder!"]
    ...
    var pageContent = ["Forever Young is a mentality, lifestyle, and choice!",
                      ...
                      "Workouts slowly increase intensity and generate new ones as you complete daily workouts, so you don't have to think, just hit start and put in the work!",

...
class AboutMeViewController: UIViewController {
    ...
    func setup() {
        ...
        aboutMeTextView.topAnchor.constraint(equalTo: view.topAnchor, constant: 100).isActive = true
        aboutMeTextView.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        aboutMeTextView.bottomAnchor.constraint(equalTo: view.bottomAnchor).isActive = true
        aboutMeTextView.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true

...
let allMPs = [shreddedMP, gainsMP, veganMP, franchizMP]
...
let franchizDinnerRecipe = Recipe(name: franchizLunchMealName, ingredients: franchizLunchIngredients, instructions: franchizLunchInstructions, mealType: Recipe.MealType.dinner, image: #imageLiteral(resourceName: "mp1image"))
...
let veganMealPlanSummary = "This is my current personal meal plan that gives me the balance I need at simplest form."
